...
這些文件由原本的課程報告重新整理而成，保留專案動機、需求、情境與流程，並移除不適合放在 README 大篇幅呈現的開發問答內容。

| 文件 | 內容 |
|---|---|
| [製作動機或目的](docs/project-background.md) | 專案背景、問題情境、目標與參與內容 |
| [功能描述](docs/requirements.md) | 使用者模式、管理者模式與功能驗收清單 |
| [情境腳本構思](docs/user-stories.md) | 使用者故事、管理者情境與主要路徑 |
| [動作流程](docs/app-flow.md) | 使用者流程、管理者流程與資料流概念 |
| [學習反思](docs/reflection.md) | 開發困難、MVVM 理解、團隊合作與後續整理方向 |
...
> **管理者試用帳密**  
> 目前管理者登入是為了課程展示與線上試玩設計，帳號與密碼皆為 `1234`。  
> 此設定僅供展示操作使用，正式產品不應使用固定帳密。
